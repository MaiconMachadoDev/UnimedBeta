...
const EspecialidadePorMes = () => {
  ...
  useEffect(() => {
    ...
    documents.forEach((doc) => {
      ...
      const dataProcedimento = new Date(doc.dataProcedimento);
      const mes = `${dataProcedimento.getFullYear()}-${String(dataProcedimento.getMonth() + 1).padStart(2, "0")}`;
      ...
      if (!data[mes][especialidade]) data[mes][especialidade] = 0;

      data[mes][especialidade]++;
    });
...
export default EspecialidadePorMes;
